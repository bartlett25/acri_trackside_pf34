...
if("TRUE" STREQUAL "TRUE")
  set(rtabmap_ros_SOURCE_PREFIX /home/acri/catkin_ws/src/rtabmap_ros)
  set(rtabmap_ros_DEVEL_PREFIX /home/acri/catkin_ws/devel)
  ...
  set(rtabmap_ros_INSTALL_PREFIX /home/acri/catkin_ws/install)
...
if(NOT "/home/acri/catkin_ws/devel/include;/home/acri/catkin_ws/src/rtabmap_ros/include;/home/acri/catkin_ws/devel/lib/rtabmap-0.20/../../include/rtabmap-0.20;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(rtabmap_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/acri/catkin_ws/devel/include;/home/acri/catkin_ws/src/rtabmap_ros/include;/home/acri/catkin_ws/devel/lib/rtabmap-0.20/../../include/rtabmap-0.20;/usr/local/include;/usr/local/include/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rtabmap_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/acri/catkin_ws/src/rtabmap_ros/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rtabmap_ros_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rtabmap_ros;/home/acri/catkin_ws/devel/lib/librtabmap_core.so;/home/acri/catkin_ws/devel/lib/librtabmap_utilite.so;/home/acri/catkin_ws/devel/lib/librtabmap_gui.so;/usr/lib/x86_64-linux-gnu/libz.so;/opt/ros/melodic/lib/libg2o_core.so;/opt/ros/melodic/lib/libg2o_types_slam2d.so;/opt/ros/melodic/lib/libg2o_types_slam3d.so;/opt/ros/melodic/lib/libg2o_types_sba.so;/opt/ros/melodic/lib/libg2o_stuff.so;/opt/ros/melodic/lib/libg2o_solver_csparse.so;/opt/ros/melodic/lib/libg2o_csparse_extension.so;/usr/lib/x86_64-linux-gnu/libcxsparse.so;/opt/ros/melodic/lib/libg2o_solver_cholmod.so;/usr/lib/x86_64-linux-gnu/libcholmod.so;/usr/lib/x86_64-linux-gnu/libfreenect.so;/usr/lib/x86_64-linux-gnu/libfreenect_sync.so;/usr/lib/libOpenNI2.so;/usr/lib/x86_64-linux-gnu/libdc1394.so;/opt/ros/melodic/lib/liboctomap.so;/opt/ros/melodic/lib/liboctomath.so;/usr/local/lib/libopencv_calib3d.so.3.2.0;/usr/local/lib/libopencv_core.so.3.2.0;/usr/local/lib/libopencv_features2d.so.3.2.0;/usr/local/lib/libopencv_flann.so.3.2.0;/usr/local/lib/libopencv_highgui.so.3.2.0;/usr/local/lib/libopencv_imgcodecs.so.3.2.0;/usr/local/lib/libopencv_imgproc.so.3.2.0;/usr/local/lib/libopencv_ml.so.3.2.0;/usr/local/lib/libopencv_objdetect.so.3.2.0;/usr/local/lib/libopencv_photo.so.3.2.0;/usr/local/lib/libopencv_shape.so.3.2.0;/usr/local/lib/libopencv_stitching.so.3.2.0;/usr/local/lib/libopencv_superres.so.3.2.0;/usr/local/lib/libopencv_video.so.3.2.0;/usr/local/lib/libopencv_videoio.so.3.2.0;/usr/local/lib/libopencv_videostab.so.3.2.0;/usr/local/lib/libopencv_viz.so.3.2.0;/usr/local/lib/libopencv_aruco.so.3.2.0;/usr/local/lib/libopencv_bgsegm.so.3.2.0;/usr/local/lib/libopencv_bioinspired.so.3.2.0;/usr/local/lib/libopencv_ccalib.so.3.2.0;/usr/local/lib/libopencv_datasets.so.3.2.0;/usr/local/lib/libopencv_dnn.so.3.2.0;/usr/local/lib/libopencv_dpm.so.3.2.0;/usr/local/lib/libopencv_face.so.3.2.0;/usr/local/lib/libopencv_freetype.so.3.2.0;/usr/local/lib/libopencv_fuzzy.so.3.2.0;/usr/local/lib/libopencv_hdf.so.3.2.0;/usr/local/lib/libopencv_line_descriptor.so.3.2.0;/usr/local/lib/libopencv_optflow.so.3.2.0;/usr/local/lib/libopencv_phase_unwrapping.so.3.2.0;/usr/local/lib/libopencv_plot.so.3.2.0;/usr/local/lib/libopencv_reg.so.3.2.0;/usr/local/lib/libopencv_rgbd.so.3.2.0;/usr/local/lib/libopencv_saliency.so.3.2.0;/usr/local/lib/libopencv_stereo.so.3.2.0;/usr/local/lib/libopencv_structured_light.so.3.2.0;/usr/local/lib/libopencv_surface_matching.so.3.2.0;/usr/local/lib/libopencv_text.so.3.2.0;/usr/local/lib/libopencv_tracking.so.3.2.0;/usr/local/lib/libopencv_xfeatures2d.so.3.2.0;/usr/local/lib/libopencv_ximgproc.so.3.2.0;/usr/local/lib/libopencv_xobjdetect.so.3.2.0;/usr/local/lib/libopencv_xphoto.so.3.2.0")
